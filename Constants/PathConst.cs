...
namespace Kitchen_Mini_Project.Constants
{
    public class PathConst
    {
        ...
        public static readonly string AnyProductDBPath = @"..\..\..\Datebase\AllInfo\AnyProduct.json";
        public static readonly string EmployeesDBPath = @"..\..\..\Datebase\Employes\Emplooyes.json";
